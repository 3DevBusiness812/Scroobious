    ...
    <AppNavigation isLoading={isLoading}>
      <Card className="mt-4" title="Schedule 1:1 Pitch Review">
        <form onSubmit={handleSubmit(onSubmit)} className="my-6 space-y-4 ">
          ...
          <Text fontSize="sm">
            Click the button below to schedule time for your 1:1 pitch review. Once you&apos;re done, fill in the form
            and submit.
          </Text>

          <Button as="a" target="_new" size="sm" href="https://calendly.com/d/cqm-wy4-w8n/1st-1-1-pitch-review">
            Schedule Time
          </Button>

          <Text fontSize="sm">
            Next, click the checkbox letting us know you&apos;ve scheduled time and submit your meeting request.
          </Text>
