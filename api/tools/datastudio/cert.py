#!/usr/bin/env python
# This file is used to generate a DB server certificate
# We use this to generate the SSL certificate for the Render DB server so that 
# we can post this to datastudio.
# Run with: python3 python3 tools/datastudio/cert.py oregon-postgres.render.com > server.crt
